        ...
        <table class="table table-striped">
            ...
            while($data = mysqli_fetch_array($result))
            {
                ...
                <tr>
                    ...
                    <td><a href="edit-navigation.php?editid=<?php echo $data['id'];?>">edit</td>
                    <td><a href="navigation-list.php?delid=<?php echo $data['id'];?>" onclick=" return confirm('Do You really want to delete this data')">delete</td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
        <a href="add-navigation.php" class="btn">Add new link</a>
